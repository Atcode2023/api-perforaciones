...
class ProjectRoute {
    ...
    initializeRoutes() {
        ...
        this.router.get(`${this.path}/:projectId/report`, auth_middleware_1.default, this.projectController.getProjectReport);
        this.router.put(`${this.path}/:id`, auth_middleware_1.default, this.projectController.updateProject);
        this.router.delete(`${this.path}/:id`, auth_middleware_1.default, this.projectController.deleteProject);
        this.router.get(`${this.path}/:projectId/has-changes`, auth_middleware_1.default, this.projectController.hasProjectChanges);
        this.router.post(`${this.path}/:projectId/reset-changes`, auth_middleware_1.default, this.projectController.resetProjectChanges);
    }
}
